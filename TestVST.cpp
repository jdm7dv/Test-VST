...
*/
bool __stdcall CTestVST::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CTestVST::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CTestVST::prepareForPlay()
{
	// Add your code here:
...
*/
bool __stdcall CTestVST::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
...
//
bool __stdcall CTestVST::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CTestVST::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CTestVST::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CTestVST::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CTestVST::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CTestVST::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CTestVST::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CTestVST::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CTestVST::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CTestVST::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CTestVST::midiClock()
{
...
bool __stdcall CTestVST::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CTestVST::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CTestVST::showGUI(void* pInfo)
{
...
bool __stdcall CTestVST::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
